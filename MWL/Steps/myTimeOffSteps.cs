...
{
    [Binding]
    public class myTimeOffSteps : BaseStep
    {
        private new readonly ParallelConfig _parallelConfig;

        public myTimeOffSteps(ParallelConfig parallelConfig) : base(parallelConfig)
        {
            _parallelConfig = parallelConfig;
        }

        [When(@"I go to the holiday request screen")]
        public void WhenTheEmployeeGoesToTheHolidayRequestScreen()
        {
             _parallelConfig.CurrentPage.As<MyTimeOffPage>().ClickReqestDaysOff();
        }
